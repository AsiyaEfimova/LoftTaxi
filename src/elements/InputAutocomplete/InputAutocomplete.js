...
const InputAutocomplete = (props) => {
    ...
    const changeHandler = (inputData) => {
        setValue({ ...inputValue, value: inputData.value });
        props.changeHandler(inputData);
    };
    // changeHandler={this.handlerInputChange}
    // const ChangeHandler = (e) => {
    //     console.log('ChangeHandler');
    //     props.changeHandler({ name: e.target.name, value: e.target.value });
    // };
    const openList = () => {
    ...
    const selectItem = (e)=>{
        setValue({ ...inputValue, value: e.target.getAttribute('value') });
        closeList();
    };
    return (
